...
# ============================================
# VERSIÓN 2: Verificación previa del motor Docker
# ============================================
log "=== Verificando servicio de Docker ==="
systemctl is-active --quiet docker || { log "ERROR: El daemon de Docker no está en ejecución."; exit 1; }
